...
namespace Global_College.mvc.Controllers
{
    public class CourseEnrolmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EnrolDate,Status,CourseId,StudentProfileId")] CourseEnrolment courseEnrolment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EnrolDate,Status,CourseId,StudentProfileId")] CourseEnrolment courseEnrolment)
        {
